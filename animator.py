...
Animations = { # Крч, этот словарь должен быть перенесен в класс Player. В Player вызывается класс Animation и туда передаются нужные данные для анимации, потом сам класс заносится в этот словарь под ключом - именем анимации.
    "Warrior": [],
    "Witch": []
}
...
class Animation(sprite.Sprite):
    ...
    animName: str
    facing: str = "Right"
    isLooped: bool = False # Зацикливание анимации (для ходьбы, айдла и т.д.)
    doesLinger: bool = False # Замирание анимации на последнем кадре (для прыжка)
    isPlaying: bool = False

    actual_frames = []
    Anim = AnimFrames[charType][animName]
    ...
    for frame in Anim:
        ...
        newframe = newframe.set_colorkey((0,0,0))
